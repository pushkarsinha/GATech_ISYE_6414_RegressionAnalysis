...
**Answer :** Without the residual analysis, it is difficult to say if model1 is significant overall. But the coefficients are statistically significant. The model looks significant based on the parameter significance
...
Comparing to Answer 2b, the model might not satisfy all the assumptions and not statisticaly significant
